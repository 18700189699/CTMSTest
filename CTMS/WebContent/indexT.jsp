...
function GoToPage(Page) 
{
    if (Page == "UserCtrl") 
    {
        form1.action = "UserCtrl/UserCtrlL.html";
    }
    if (Page == "StudentCtrl") 
    {
...
function UpdatePassWord() {
    window.open("UpdatePassWord.html", '', 'resizable=no,width=350,height=200,left=500px,top=350px');
}
</script>
</head>
<body>
...
<table class="tbl" cellspacing=1 cellpadding=0 width="100%" height="100%" border=0 >
  ...
  <tr>
    <td height="5%" style="BACKGROUND-COLOR: #f0f0f0;"><table width="100%" height="100%" border=0 align="center">
        <tr>
          <td width="100%"><div align="left" style="width:50%;float:left;"> <span id="time">
            ...
            <div style="width:50%;float:left;"> <img src="images/zhuxiao.JPG" width="34" height="20" onclick="GoOut();" border="0" align="right"> <img src="Images/mimaxiugai.JPG" width="70" height="20" border="0" onclick="UpdatePassWord();" align="right"> </div>
            </td>
        </tr>
        <tr>
        <td width="100%">
